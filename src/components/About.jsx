  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full green-pink-gradient p-[1px] rounded-[20px] dark:shadow-card shadow-light_card"
      >
        <div className="dark:bg-tertiary bg-light_tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col">
          <img src={icon} alt={title} className="w-16 h-16 object-contain" />
          <h3 className="dark:text-white text-black text-[20px] font-bold text-center">
            {title}
          </h3>
        </div>
      </motion.div>
  ...
  return (
    <>
      ...
      <motion.p
        ...
        className="mt-4 dark:text-secondary text-light_secondary text-[17px] max-w-3xl leading-[30px]"
      >
